...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      titleSlideClass: [bottom, left, exclude]
...
.inverse {
  background-image: url("./siegel_FFFFFF.png");
  background-size: 30em;
  background-position: bottom right;
}
.title-slide {
  background-image: url("./UFR-logo_FFFFFF.png"), 
                    url("./siegel_A4B1E0.png");
  background-position: 7.35% 8%, bottom right; 
  background-size: 15em, 30em; 
}
.remark-slide-content:not(.exclude){
  background-image: url(./UFR-logo_344A9A.png);
  background-position: 9.95% 98%;
...
style_duo_accent(
  primary_color = "#344A9A",
  secondary_color = "#A4B1E0",
  inverse_header_color = "#FFFFFF", 
  # title_slide_background_image = "./siegel_A4B1E0.png", 
  # title_slide_background_position = c("bottom right"), 
  # title_slide_background_size = "30em", 
...
Dolor imperdiet nostra sapien scelerisque praesent curae metus facilisis dignissim tortor. Lacinia neque mollis nascetur neque urna velit bibendum. 
...
class: inverse left middle exclude
...
Adapted by: [Raphael Hartmann](https://github.com/RaphaelHartmann/uf_xaringan)
